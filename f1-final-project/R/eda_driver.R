...
# e.g. df <- rename(df, year = RaceYear, driver = DriverName)

# Example: summary of fatal drivers by year
if ("year" %in% names(df)) {
...
# Save plots to docs/img or docs/plots for embedding
